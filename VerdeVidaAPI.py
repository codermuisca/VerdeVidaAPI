"""API sobre especies amenazadas.
   API Rest encargada de exponer información sobre las especies 
   en la Categoría Amenazadas según la clasificación de la Lista Roja de la UICN 
   en los Departamentos de Boyacá y Cundinamarca, que se encuentra contenida en los archivo en formato JSON:
   
  1 especies_amenazadas_boyaca.json 
  2 especies_amenazadas_cundinamarca.json

Expone funciones como servicios, y estos métodos reciben como argumento general el tipo de consulta 
para así saber cual fuente o archivo de datos usar.
...
"""
__author__ = "CoderMuisca"
__copyright__ = "Copyright 2024, Desaextremo"
__credits__ = ["Desaextremo, CoderMuisca"]
__license__ = "GPL"
__version__ = "1.0.1"
__maintainer__ = "Team Desaextremo"
__email__ = "macordons@unal.edu.co"
...
def retornar_datos(tipo_consulta: int,inferior: int,superior: int):
    ...
    """
    datos = []
    nombre_archivo = 'especies_amenazadas_boyaca.json'

    if tipo_consulta==1:
        nombre_archivo = "especies_amenazadas_boyaca.json"
    elif tipo_consulta==2:
        nombre_archivo = "especies_amenazadas_cundinamarca.json"
